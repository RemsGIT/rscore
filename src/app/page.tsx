            ...
            <section className="relatve h-full flex justify-center items-center">
                <div className="mx-auto mb-12 w-full max-w-3xl text-center md:mb-16 lg:mb-20">
                    ...
                    <div className="flex justify-center">
                        <Link href="/games" className="mr-5 flex rounded-xl bg-black px-6  py-4 text-center font-semibold text-white [box-shadow:rgb(51,153,102)_6px_6px] mt-5 group duration-150 hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all  ease-in-out">
                            {"Créer ma partie"}
                            <MoveRight className={"ml-2 transition-all duration-300 group-hover:translate-x-1.5"} />
                        </Link>
                    </div>
                </div>
            </section>
